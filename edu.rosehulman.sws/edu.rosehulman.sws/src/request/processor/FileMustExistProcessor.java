 ...
 */
public abstract class FileMustExistProcessor implements RequestProcessor {
    ...
    public HttpResponse process(HttpRequest request) {
        File file = checkIfFileExists(request);
        if(file != null) {
    ...
    protected File checkIfFileExists(HttpRequest request) {
